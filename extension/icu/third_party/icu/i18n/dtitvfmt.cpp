...
DateIntervalFormat::operator==(const Format& other) const {
    ...
    //       fDateFormat has the feature calendar for the DateIntervalFormat.
...
DateIntervalFormat::adoptTimeZone(TimeZone* zone)
{
    ...
    // The fDateFormat has the feature calendar for the DateIntervalFormat and has
...
DateIntervalFormat::setTimeZone(const TimeZone& zone)
{
    ...
    // The fDateFormat has the feature calendar for the DateIntervalFormat;
