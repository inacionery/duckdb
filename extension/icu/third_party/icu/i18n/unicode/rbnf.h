 ...
 *   <tr>
 *     <td>x.0:</td>
 *     <td>The rule is a <em>feature rule</em>. If the full stop in
 *     the middle of the rule name is replaced with the decimal point
 *     that is used in the language or DecimalFormatSymbols, then that rule will
 *     have precedence when formatting and parsing this rule. For example, some
 ...
 *
 * <ul>
 *   <li>If the rule set includes a feature rule (and the number was passed in as a <tt>double</tt>),
 *     use the feature rule.&nbsp; (If the number being formatted was passed in as a <tt>long</tt>,
 *     the feature rule is ignored.)</li>
 ...
 *   <tr>
 *     <td></td>
 *     <td>in fraction or feature rule</td>
